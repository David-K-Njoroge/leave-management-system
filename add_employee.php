...
if(isset($_POST['submit'])){
	...
	if($id>0){
		$sql="update employee set name='$name',email='$email',mobile='$mobile',password='$password',department_id='$department_id',address='$address',date_of_birth='$date_of_birth' where id='$id'";
	}else{
		$sql="insert into employee(name,email,mobile,password,department_id,address,date_of_birth,role) values('$name','$email','$mobile','$password','$department_id','$address','$date_of_birth','2')";
	}
                           ...
                           <form method="post">
							   <div class="form-group">
								...
								<div class="form-group">
									...
									<input type="date" value="<?php echo $date_of_birth?>" name="date_of_birth" placeholder="Enter employee date_of_birth" class="form-control" required>
								</div>
